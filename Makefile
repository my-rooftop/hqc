...
CPP_FLAGS:=-O0 -Wall -Wextra -Wpedantic -Wvla -Wredundant-decls -g
...
HQC_OBJS:=vector.o reed_muller.o reed_solomon.o fft.o gf.o gf2x.o code.o parsing.o hqc.o kem.o shake_ds.o shake_prng.o excel_utils.o
